...
export default function Contact({ settings }) {
  ...
  const apiKey = settings?.w3ckey || "da6588c7-6cfd-4a96-baff-04c737482d9d";

  const { submit: onSubmit } = useWeb3Forms({
    access_key: apiKey,
    settings: {
      from_name: "Viinart",
      subject: "New Contact Message from Viinart Website"
    },
    onSuccess: (msg, data) => {
      setIsSuccess(true);
      setMessage(msg);
  ...
  return (
    <Container>
      ...
      <div className="text-center">
        <p className="text-lg">Let us bring your artistic vision to life. Share your creative requests with us.</p>
      </div>
        ...
        <div className="my-10">
          ...
          <div className="mt-5">
            <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
              ...
              <span>Tampa - St. Petersburg, Florida</span>
            </div>
            {settings?.email && (
              <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
